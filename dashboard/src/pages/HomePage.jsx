...
const HomePage = () => {
  ...
  return (
    <div className="flex min-h-screen w-full flex-col bg-muted/40">
      ...
      <header className="sticky ml-6.5 top-0 z-30 flex h-14 items-center gap-4 border-b bg-background px-4 sm:static sm:h-auto sm:border-0 sm:bg-transparent sm:px-6 max-[900px]:h-[100px]">
        ...
        <div className="flex items-center gap-4 md:grow-0 sm:ml-5 sm:mt-5">
          <img
