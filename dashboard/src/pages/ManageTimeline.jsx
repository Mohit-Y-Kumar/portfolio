    ...
    <div className="flex min-h-screen w-full flex-col bg-muted/40">
      <Tabs defaultValue="week">
        <TabsContent value="week">
          <Card>
            <CardHeader className="flex gap-4 sm:justify-between sm:flex-row sm:items-center bg-gray-300">
            ...
            <CardContent className="grid grid-cols-1 gap-4 bg-amber-100 text-black" >
              <Table>
                <TableHeader>
                  <TableRow>
