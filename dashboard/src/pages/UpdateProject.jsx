...
const UpdateProject = () => {
  ...
  useEffect(() => {
    const getProject = async () => {
      await axios
        .get(`https://portfolio-3wz3.onrender.com/api/v1/project/get/${id}`, {
        ...
        >
          ...
          <div className="mt-6 flex items-center justify-end gap-x-6">
            {loading ? (
              ...
              <button
                type="submit"
                className="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible: focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 w-52"
              >
                Update
              </button>
